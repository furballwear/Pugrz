...
public class Constants {
    ...
    public static final String EXTRA_GAMETYPE = "extra_gametype";
    public static final String EXTRA_GAMESTYLE = "extra_gamestyle";
    public static final String EXTRA_GAMEDATE = "extra_gamedate";
    public static final String EXTRA_GAMETIME = "extra_gametime";
