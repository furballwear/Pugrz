...
import com.furballwear.apps.pugrz.adapters.FreindsAdapter;
...
public class FreindsActivity extends AppCompatActivity {
	...
	private FreindsAdapter adapter = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		progressDialog = new ProgressDialog(FreindsActivity.this);
		...
		buttonAdd.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(task.length()==0){
					Toast.makeText(FreindsActivity.this, getText(R.string.task_blank), Toast.LENGTH_SHORT).show();
				}
				else {
	...
	//		progressDialog.show();
		...
		protected RecordsResponse doInBackground(Void... params) {
			...
			try {
				RecordsResponse records = dbApi.getRecords(IAppConstants.TABLE_FRIENDS,null,null,-1,-1,null,null,false,false,null,null,true,null);
		...
		//		progressDialog.cancel();
			...
			if(records != null){ // success
				adapter = new FreindsAdapter(FreindsActivity.this, records.getRecord());
	...
	//		progressDialog.show();
		...
		protected RecordResponse doInBackground(String... params) {
			...
			try {
				...
				RecordResponse resultRecord = dbApi.createRecord(IAppConstants.TABLE_FRIENDS,"123", record, null, null, null,null);
		...
		//	progressDialog.cancel();
			if(record != null){
				...
				Toast.makeText(FreindsActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
			}
		}
	}
}
