...
package com.furballwear.apps.pugrz.basicsyncadapter.provider;
...
import com.furballwear.apps.pugrz.common.db.SelectionBuilder;
...
public class FeedProvider extends ContentProvider {
    ...
    static {
     //   sUriMatcher.addURI(AUTHORITY, "record", ROUTE_ENTRIES);
     //   sUriMatcher.addURI(AUTHORITY, "record/*", ROUTE_ENTRIES_ID);
    ...
    static class FeedDatabase extends SQLiteOpenHelper {
        ...
        private static final String SQL_CREATE_ENTRIES =
                "CREATE TABLE " + FeedContract.Entry.TABLE_NAME + " (" +
                        ...
                        FeedContract.Entry.COLUMN_NAME_SHORTDES    + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_GAMETYPE    + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_GAMESTYLE    + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_GAMEDATE    + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_GAMETIME    + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_USER_ID_CREATE    + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_GAMECITY    + TYPE_TEXT + COMMA_SEP +
                        FeedContract.Entry.COLUMN_NAME_GLOCATION    + TYPE_TEXT + ")";
