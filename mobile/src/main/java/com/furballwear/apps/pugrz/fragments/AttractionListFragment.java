...
import com.furballwear.apps.pugrz.activities.MainActivity;
...
import com.furballwear.apps.pugrz.provider.TouristAttractions;
import com.furballwear.apps.pugrz.service.UtilityService;
import com.furballwear.apps.pugrz.adapters.AttractionsRecyclerView;
...
public class AttractionListFragment extends Fragment {
    ...
    private class AttractionAdapter extends RecyclerView.Adapter<ViewHolder>
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.mGamedate.setText(attraction.gamedate);
            if (attraction.gamestyle.equals("Furballwears Secert")){
                holder.mImageView2.setImageDrawable(getResources().getDrawable(R.drawable.furballgame));
            }
            if (attraction.gamestyle.equals("Open Public")){
                holder.mImageView2.setImageDrawable(getResources().getDrawable(R.drawable.public_out_doors_events));
            }
            if (attraction.gamestyle.equals("Hosted Event")){
                holder.mImageView2.setImageDrawable(getResources().getDrawable(R.drawable.open_game));
            }
            if (attraction.gamestyle.equals("Private parsonal")){
                holder.mImageView2.setImageDrawable(getResources().getDrawable(R.drawable.privet_invite_event_pink));
            }
            if (attraction.gamestyle.equals("Tornament")){
                holder.mImageView2.setImageDrawable(getResources().getDrawable(R.drawable.tournament_games_red));
            }
        }
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View view, ItemClickListener itemClickListener) {
            super(view);
            mGamedate = (TextView)view.findViewById(R.id.textViewdate);
            ...
            mImageView2 = (ImageView)view.findViewById(android.R.id.icon1);
