...
public class FreindsAdapter extends BaseAdapter {
	...
	public FreindsAdapter(Context context, List<RecordResponse> records) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {		
		...
		if (convertView == null){
			...
			holder.tv_task = (TextView) convertView.findViewById(android.R.id.text1);
	...
	class DeleteRecordTask extends AsyncTask<Object, String, String>{
		...
		protected String doInBackground(Object... params) {
			...
			try {
				...
				dbApi.deleteRecord(IAppConstants.TABLE_FRIENDS, record.getId(), null, null, null,null);
				records.remove(pos);
...
//				Record result = dbApi.updateRecord(IAppConstants.TABLE_NAME, record.getId(), null, record, null, null);
				RecordResponse result = dbApi.updateRecord(IAppConstants.TABLE_FRIENDS, recordRequest.getId(),recordRequest, null, null,null, null);
