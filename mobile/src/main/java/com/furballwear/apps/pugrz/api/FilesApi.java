...
import com.furballwear.apps.pugrz.model.ComponentList;
import com.furballwear.apps.pugrz.model.Container;
import com.furballwear.apps.pugrz.model.ContainerRequest;
import com.furballwear.apps.pugrz.model.ContainerResponse;
import com.furballwear.apps.pugrz.model.ContainersRequest;
import com.furballwear.apps.pugrz.model.ContainersResponse;
import com.furballwear.apps.pugrz.model.File;
import com.furballwear.apps.pugrz.model.FileRequest;
import com.furballwear.apps.pugrz.model.FileResponse;
import com.furballwear.apps.pugrz.model.Folder;
import com.furballwear.apps.pugrz.model.FolderRequest;
import com.furballwear.apps.pugrz.model.FolderResponse;
...
public class FilesApi {
	...
	public FolderResponse getFolder (String container, String folder_path, Boolean include_properties, Boolean include_folders, Boolean include_files, Boolean full_tree, Boolean zip) throws ApiException {
		...
		// create path and map variables
		String path = serviceName + "/{container}/{folder_path}/".replaceAll("\\{format\\}","json").replaceAll("\\{" + "container" + "\\}", apiInvoker.escapeString(container.toString())).replaceAll("\\{" + "folder_path" + "\\}", apiInvoker.escapeString(folder_path.toString()));
